  ...
  return (
    <main className="w-full min-h-[590px] h-full max-w-full flex items-center justify-center ">
      <div className="w-full h-full p-5 rounded-md">
        ...
        <h1
          className="text-xl tracking-[-0.16px] dark:text-slate-500 font-bold mb-4 mt-8
        text-center sm:text-left"
        >
          Account confirmation
        </h1>
        <p className="mb-6 text-center sm:text-left text-[15px] dark:text-slate-500 font-normal">
        ...
        <p className="mt-6 text-sm text-muted-foreground dark:text-slate-500 font-normal">
